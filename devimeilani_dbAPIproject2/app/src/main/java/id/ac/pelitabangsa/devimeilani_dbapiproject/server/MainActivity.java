package id.ac.pelitabangsa.devimeilani_dbapiproject.server;
...
import id.ic.pelitabangsa.dendiyp.devimeilani.adapter.ListAdapterHandphone;
import id.ic.pelitabangsa.dendiyp.devimeilani.model.Handphone;
import id.ic.pelitabangsa.dendiyp.devimeilani.server.AsyncInvokeURLTask;
...
public class MainActivity extends ActionBarActivity implements SearchView.OnQueryTextListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) { getMenuInflater().inflate(R.menu.activity_main, menu);
        ...
        if (searchView == null) { MenuItemCompat.setShowAsAction(searchItem,
                    MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW | MenuItem.SHOW_AS_ACTION_ALWAYS);
            MenuItemCompat.setActionView(searchItem, searchView = new SearchView(id.ic.pelitabangsa.devimeilani.MainActivity.this));
        }
    ...
    public void loadDataHP() {
        ...
        task.applicationContext = id.ic.pelitabangsa.devimeilani.MainActivity.this;
