...
public class DetailHandphone extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_menu_edit:
                Intent in = new Intent(getApplicationContext(), id.ic.pelitabangsa.dendiyp.devimeilani.FormHandphone.class);
    ...
    public void deleteData() {
        try {
            ...
            task.applicationContext = id.ic.pelitabangsa.dendiyp.devimeilani.DetailHandphone.this;
